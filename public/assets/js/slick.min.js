...
$('.product-detail-nav').slick({
  slidesToShow: 3,
  slidesToScroll: 1,
  asNavFor: '.product-detail-main',
  dots: false,
  focusOnSelect: true
});
$('.blog-table-main').slick({
  slidesToShow: 1,
  slidesToScroll: 1,
  arrows: false,
  fade: true,
  dots:false,
  asNavFor: '.blog-table-nav'
});
$('.blog-table-nav').slick({
  slidesToShow: 3,
  slidesToScroll: 1,
  asNavFor: '.blog-table-main',
  dots: false,
  focusOnSelect: true,
  arrows:false,
  responsive: [
...
$('.popup-product-list-slider').slick({
  dots: true,
  infinite: false,
  speed: 600,
  slidesToShow: 1,
...
$(window).on('load', function() {
    $('.menu-blog-slider').slick('slickGoTo', 0);
